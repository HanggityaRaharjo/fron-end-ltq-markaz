...
function BarangKeluar() {
    ...
    const [tambahBarangKeluar, setTambahBarangKeluar] = useState(false)
    const [editBarangkeluar, setEditBarangKeluar] = useState(false)

    const HandleTambahBarangKeluar = () => {
        setTambahBarangKeluar(true)
    }

    const HandleEditBarang = () => {
        setEditBarangKeluar(true)
    }
...
const TabelDataKeluar = ({ no, name, jumlah_barang, tanggal, deskripsi, edit }) => {
    return (
        <tr>
            ...
            <div className='flex justify-center items-center h-full'>
                <div className='bg-white max-h-[500px] w-[500px]  rounded-md p-5'>
                    ...
                    <div className='mt-5 flex flex-col gap-2'>
                        ...
                        <div className="flex flex-col">
                            <label className="font-medium" >Tanggal keluar</label>
                            <input type="text" className='h-10 border-b-2 focus:border-[#169859]  w-full outline-none' />
                        </div>
                        <div className="flex flex-col">
