            ...
            <section className='p-5 bg-white shadow-md rounded-md'>
                <div>
                    ...
                    <div className='flex justify-end mt-10'>
                        <Link to={'/form/pengaturan-akun-tu'} className="px-5 py-1 bg-[#169859] text-white rounded-md active:scale-95 duration-300">Edit</Link>
                    </div>
                    <div>
...
export default PengaturanAkunTu