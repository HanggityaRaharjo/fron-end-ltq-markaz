        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center py-20 bg-[#f1fff8] ">
          ...
          <div className="flex justify-center">
            <div className="w-10/12 md:10/12 pt-5">
              <h1 className="text-[50px] text-center font-extrabold mb-5">
                Madrasah <span className="text-[#169859]">Diniyyah</span>
              </h1>
              ...
              <div className="w-full flex justify-center items-center py-10 px-5 bg-[#cafee6] rounded-md ">
                <div className="flex justify-center lg:justify-start">
                  <div className="flex flex-col gap-2">
                    ...
                    <p>
                      Madrasah diniyah (juga dikenal sebagai madrasah diniyah takmiliyah) adalah institusi pendidikan Islam tradisional yang berfokus pada pendidikan agama Islam. Berbeda dengan sekolah umum yang menawarkan kurikulum yang mencakup berbagai mata pelajaran, madrasah diniyah secara khusus didesain untuk mempelajari dan mengajarkan agama Islam, termasuk Quran, hadis, tafsir (interpretasi Quran), fiqih (hukum Islam), akhlak (moral dan etika), dan sejarah Islam
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full flex justify-center items-center py-10 px-5 bg-[#cafee6] rounded-md ">
                <div className="flex justify-center lg:justify-start">
                  <div className="flex flex-col gap-2">
                    ...
                    <p>
                      Madrasah diniyah memiliki peran penting dalam komunitas Muslim. Mereka membantu menjaga tradisi keagamaan dan moral dalam masyarakat Muslim. Seringkali, madrasah diniyah juga berfungsi sebagai pusat keagamaan dalam masyarakat, tempat untuk beribadah, kuliah agama, dan kegiatan sosial lainnya.
                    </p>
                  </div>
                </div>
              </div>
