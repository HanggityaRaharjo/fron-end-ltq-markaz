  ...
  return (
    <Layout>
      <section className="p-5 font-poppins">
        ...
        <div className="mt-10 bg-white rounded-md shadow-lg p-5">
          <div className="mb-5">
            <h1 className="font-semibold text-4xl">kelas Tersedia</h1>
          </div>
            ...
            <CardCLass
              ...
              icons={
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-40 h-40 text-[#65add790]"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <CardCLass
              ...
              icons={
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-40 h-40 text-[#95cc7b9e]"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <CardCLass
              ...
              icons={
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-40 h-40 text-[#f4dea671]"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <CardCLass
              ...
              icons={
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-40 h-40 text-[#f7c8a8a7]"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
