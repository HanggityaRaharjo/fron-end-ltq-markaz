...
function InputnilaiSiswa() {
    ...
    const [isTambahNilai, setIsTambahNilai] = useState(false);

    const HandleTambahNilai = () => {
        setIsTambahNilai(true)
    }
    ...
    return (
        <Layout>
            <ModalEditNilai
                show={showmodal}
                close={setShowModal} />
            <TambahNilaiSiswa show={isTambahNilai} close={setIsTambahNilai} />
            <section className='p-5 font-poppins'>
                <div className=' '>
                    <div>
                        <h1 className='font-bold text-xl'>Nilai Siswa</h1>
                    </div>
                    <div className="flex justify-end">
                        <button
                            onClick={() => HandleTambahNilai()}
                            className="flex items-center gap-2 p-2 bg-[#169859] rounded-md text-white active:scale-95 duration-300">
                    ...
                    <div className='mt-5 bg-white  shadow-lg rounded-lg overflow-auto'>
                        <table className='w-full'>
                            <thead>
                                <tr className='bg-black text-white'>
                                    <td className='p-2 text-center w-[50px]'>No</td>
                                    <td className='p-2 text-center w-[200px]'>Nama</td>
                                    <td className='p-2 text-center w-[150px]'>Talaqqi</td>
                                    <td className='p-2 text-center w-[150px]'>Tartil</td>
                                    <td className='p-2 text-center w-[150px]'>Tilawah</td>
                                    <td className='p-2 text-center w-[50px]'>action</td>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div className='p-5 w-[400px] max-h-[700px] bg-white rounded-lg'>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        <div className="flex flex-col">
                            <label className="font-medium" >Nilai 1</label>
                            <input type="number" className='h-10 border-b-2 focus:border-[#169859]  w-full outline-none' />
                        </div>
                        <div className="flex flex-col">
                            <label className="font-medium" >Nilai 2</label>
                            <input type="number" className='h-10 border-b-2 focus:border-[#169859]  w-full outline-none' />
                        </div>
                        <div className="flex flex-col">
                            <label className="font-medium" >Nilai 3</label>
                            <input type="number" className='h-10 border-b-2 focus:border-[#169859]  w-full outline-none' />
                        </div>
...
function TambahNilaiSiswa({ show, close }) {
    return (
        <div className={`fixed z-[1000] left-0 top-0 h-screen w-screen bg-black bg-opacity-50 justify-center items-center transition-all duration-300 ${show ? 'top-0' : 'top-[-1000px]'} `}>
            <div className='flex justify-center items-center h-full w-full'>
                <div className='p-5 w-[400px] max-h-[700px] bg-white rounded-lg'>
                    <h1 className='font-bold text-2x1'>Tambah Nilai Siswa</h1>
