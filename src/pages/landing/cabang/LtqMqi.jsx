        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center py-20 bg-[#f1fff8]">
          ...
          <div className="flex justify-center  md:hidden">
            <div className="w-10/12 ">
              <img src={"/image/LTQ.png"} alt="" className="w-full" />
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="w-10/12 md:10/12 pt-5">
              ...
              <p>
                Di sini, kami membawa warisan Alquran kepada Anda dengan
                ...
                <div className="flex justify-center lg:justify-start">
                  <div className="flex flex-col gap-2">
                    ...
                    <p>
                      ...
                      Lembaga Markaz Quran yang sudah dikenal secara luas di
                      seluruh dunia. Kami berkomitmen untuk menyediakan
                      pendidikan Alquran berkualitas tinggi dan memahaminya
                      dengan mendalam. Dengan pengalaman bertahun-tahun dalam
                      mengajar dan memahami Alquran, kami adalah mitra
                      terpercaya dalam perjalanan spiritual dan intelektual
                      Anda.
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className=" md:hidden flex justify-center lg:h-[500px]">
                <div className="w-[400px] h-[380px] flex justify-end">
                  <img src={"/education.svg"} alt="" className="h-full" />
                </div>
              </div>
              <div className="w-full flex justify-center items-center py-10 px-5 bg-[#cafee6] rounded-md ">
                <div className="flex justify-center lg:justify-start">
