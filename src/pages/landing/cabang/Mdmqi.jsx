...
function Card({ img, title, label }) {
  return (
    <div className="flex justify-center border bg-white rounded-xl p-2 border-gray-200 hover:shadow">
  ...
  return (
    <LayoutColumn>
      <section className="pt-20">
        ...
        <div className="mt-20 flex justify-center bg-[#cafee6] rounded-r-full py-10">
