...
function CountdownPembayaran() {
    ...
    useEffect(() => {
        axios.get('http://192.168.43.81:8000/api/program-pembayaran', {
            headers: {
    ...
    return <Layout>
        <section className='min-h-screen bg-white flex justify-center items-center font-poppins'>
            <div className='h-auto w-[500px] rounded-lg shadow-lg px-5 border'>
                ...
                {dataPembayaran && dataPembayaran.map((item) => (
                    <div className='mt-10 mb-10'>
                        <div className='mt-2'>
                            <div className='flex justify-center'>
                                <div className='h-[100px] w-[180px]'>
                                    <img src={`http://192.168.43.81:8000/storage/${item.pembayaran.type_bank}`} alt="" className='h-full w-full' />
                                </div>
                            </div>
                            <div className='flex justify-center'>
