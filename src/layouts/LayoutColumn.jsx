    ...
    <>
      ...
      <div className="p-5 min-h-screen">
        <div className="flex justify-center mb-5">
          <h3 className="text-4xl font-semibold">F . A . Q</h3>
        </div>
...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <div className="single-faq mb-8 w-full rounded-lg border-2 border-[#F3F4FE] bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
      <button
